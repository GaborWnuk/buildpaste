...
stonecutter {
	create(rootProject) {
		/**
		 * Creates version nodes named `versions/{project}-{loader}`, each using the
		 * loader-specific `build.{loader}.gradle.kts` build script. Adding support for a
		 * newer Minecraft release is a single `match(...)` line here.
		 */
